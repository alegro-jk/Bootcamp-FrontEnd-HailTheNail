...
class AdminViewGentriPerf extends Component {

    constructor (props) {
        super(props)
        this.state = {
            human: "",
            // result: "STAFF PERFORMANCE (GENTRI BRANCH):\n• Minatozaki Sana: Excellent\n• Yoo Jeongyeon: Excellent\n• Son Chaeyoung: Excellent"
            staffs: [
                { staff: "Minatozaki Sana", daily: 24, weekly: 144, monthly: 576 },
                { staff: "Park Jihyo", daily: 25, weekly: 150, monthly: 600 },
                { staff: "Myoui Mina", daily: 26, weekly: 156, monthly: 624 },
