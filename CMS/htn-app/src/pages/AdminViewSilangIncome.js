...
class AdminViewSilangIncome extends Component {
        ...
        <div id="hdr">
            ...
            <div className="body">
                ...
                <div className="content">
                    <div>
                        <h1 id='title'>SILANG Income Report</h1>
                        <h3>• Daily</h3>
                        <table id='table'>
                        <tbody>
...
{/* <button id="sortButton" onClick={handleSort}>Sort</button> */}

// function handleSort() {
//    // var sort = document.getElementById("sortButton");
//    var sortCash = this.props.cash;
//    sortCash(sortCash);
// }
