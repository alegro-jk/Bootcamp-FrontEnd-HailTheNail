...
class AdminViewNasugbuPerf extends Component {

    constructor (props) {
        super(props)
        this.state = {
            human: "",
            // result: "STAFF PERFORMANCE (NASUGBU BRANCH):\n• Minatozaki Sana: Excellent\n• Yoo Jeongyeon: Excellent\n• Son Chaeyoung: Excellent"
            staffs: [
                { staff: "Kim Dahyun", daily: 24, weekly: 144, monthly: 576 },
                { staff: "Son Chaeyoung", daily: 25, weekly: 150, monthly: 600 },
                { staff: "Chou Tzuyu", daily: 26, weekly: 156, monthly: 624 },
