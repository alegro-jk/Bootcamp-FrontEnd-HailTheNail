...
class AdminViewSilangBookings extends Component {

    constructor (props) {
        super(props)
        this.state = {
            human: "",
            // result: "BOOKINGS (SILANG BRANCH):\n• Manicure\n   -Daily: 12\n   -Weekly: 72\n   -Monthly: 288\n\n• Pedicure\n   -Daily: 12\n   -Weekly: 72\n   -Monthly: 288\n\n• Nail Extension\n   -Daily: 5\n   -Weekly: 30\n   -Monthly: 120\n\n• Nail Art\n   -Daily: 12\n   -Weekly: 72\n   -Monthly: 288\n\n• Cryotherapy\n   -Daily: 2\n   -Weekly: 12\n   -Monthly: 48\n\n• Chemical Peeling\n   -Daily: 3\n   -Weekly: 18\n   -Monthly: 72\n\n"
            services: [
        ...
        <div id="hdr">
            ...
            <div className="body">
                ...
                <div className="content">
                    <div>
                        <h1 id='title'>SILANG Booking History</h1>
                        <table id='table'>
                        <tbody>
...
export default AdminViewSilangBookings;
